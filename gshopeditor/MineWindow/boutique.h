...
public ref struct Item
{
	...
	array<unsigned char>^ gift_name; // 64 Byte Unicode
	array<unsigned char>^ gift_surface_path; // 128 Byte GBK
	array<unsigned char>^ gift_description; // 1024 Byte Unicode
	int gift_id;
	int gift_amount;
	int gift_duration;
	int log_price;
	...
	bool new_icon;
	int unk1;
	array<unsigned char>^ unk2; //3 byte
	int unk3;
	int unk4;
	array<unsigned char>^ unk5; //1 byte
	array<unsigned char>^ unk6; //128 byte
};
